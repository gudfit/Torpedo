...
- DeepLOB variants (imported from torpedocode.models.baselines)
...
from ..models.baselines import DeepLOBFull, DeepLOB2018Model  # type: ignore
import numpy as np
...
def main():
    ...
    if args.baseline == "logistic":
        ...
        # Use shared DeepLOBFull from models.baselines
